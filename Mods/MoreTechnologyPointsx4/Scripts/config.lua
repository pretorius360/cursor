...
local palConfig = {
    ...
    palModName = "More Stat and Technology Points",
    palModVersion = "1.12",
    ...
    -- Modifier for TechnologyPointPerLevel
    palTechnologyPointPerLevel = 24,
    -- Modifier for TechnologyPointPerLevel
    palTechnologyPointUnlockFastTravel = 4,
    -- Modifier for TechnologyPointPerLevel
    palTechnologyPointPerTowerBoss = 20,
    -- Modifier for TechnologyPointPerLevel
    palTechnologyPointPerNormalBoss = 4    
